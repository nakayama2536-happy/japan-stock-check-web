const CACHE="jpstock-v1-5-5";
const SHELL=["./","index.html","style.css?v=1.5.5","app.js?v=1.5.5","manifest.webmanifest","icons/icon-192.png?v=1.5.5","icons/icon-512.png?v=1.5.5"];
