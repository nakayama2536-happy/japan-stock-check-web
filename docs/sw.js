const CACHE="jpstock-v1-4-5";
const SHELL=["./","index.html","style.css?v=1.4.5","app.js?v=1.4.5","manifest.webmanifest","icons/icon-192.png?v=1.4.5","icons/icon-512.png?v=1.4.5"];
