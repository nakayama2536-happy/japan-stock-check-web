const CACHE="jpstock-v1-6-0";
const SHELL=["./","index.html","style.css?v=1.6.0","app.js?v=1.6.0","manifest.webmanifest","icons/icon-192.png?v=1.6.0","icons/icon-512.png?v=1.6.0"];
