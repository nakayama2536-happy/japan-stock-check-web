const CACHE="jpstock-v1-3-1";
const SHELL=["./","index.html","style.css?v=1.3.1","app.js?v=1.3.1","manifest.webmanifest","icons/icon-192.png?v=1.3.1","icons/icon-512.png?v=1.3.1"];
