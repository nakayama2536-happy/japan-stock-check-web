const CACHE="jpstock-v1-6-3";
const SHELL=["./","index.html","style.css?v=1.6.3","app.js?v=1.6.3","manifest.webmanifest","icons/icon-192.png?v=1.6.3","icons/icon-512.png?v=1.6.3"];
