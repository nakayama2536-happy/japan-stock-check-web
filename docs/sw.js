const CACHE="jpstock-v1-4-4";
const SHELL=["./","index.html","style.css?v=1.4.4","app.js?v=1.4.4","manifest.webmanifest","icons/icon-192.png?v=1.4.4","icons/icon-512.png?v=1.4.4"];
