const CACHE="jpstock-v1-4-6";
const SHELL=["./","index.html","style.css?v=1.4.6","app.js?v=1.4.6","manifest.webmanifest","icons/icon-192.png?v=1.4.6","icons/icon-512.png?v=1.4.6"];
