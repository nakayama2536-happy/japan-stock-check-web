const CACHE="jpstock-v1-6-2";
const SHELL=["./","index.html","style.css?v=1.6.2","app.js?v=1.6.2","manifest.webmanifest","icons/icon-192.png?v=1.6.2","icons/icon-512.png?v=1.6.2"];
