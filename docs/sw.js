const CACHE="jpstock-v1-4-7";
const SHELL=["./","index.html","style.css?v=1.4.7","app.js?v=1.4.7","manifest.webmanifest","icons/icon-192.png?v=1.4.7","icons/icon-512.png?v=1.4.7"];
