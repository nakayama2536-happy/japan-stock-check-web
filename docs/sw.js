const CACHE="jpstock-v1-5-3";
const SHELL=["./","index.html","style.css?v=1.5.3","app.js?v=1.5.3","manifest.webmanifest","icons/icon-192.png?v=1.5.3","icons/icon-512.png?v=1.5.3"];
