const CACHE="jpstock-v1-5-6";
const SHELL=["./","index.html","style.css?v=1.5.6","app.js?v=1.5.6","manifest.webmanifest","icons/icon-192.png?v=1.5.6","icons/icon-512.png?v=1.5.6"];
